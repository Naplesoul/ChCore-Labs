                             ...
                             struct ipc_vm_config *client_vm_config)
{
        ...
        /* LAB 4 TODO BEGIN */
        server_stack_base = vm_config->stack_base_addr
                + conn_idx * vm_config->stack_size;
        /* LAB 4 TODO END */
        ...
        /* LAB 4 TODO BEGIN */
        server_buf_base = vm_config->buf_base_addr
                + conn_idx * vm_config->buf_size;
        ...
        vmspace_map_range(source->vmspace, client_buf_base, buf_size,
                          VMR_READ | VMR_WRITE, buf_pmo);
        /* LAB 4 TODO END */
